																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">You are receiving this email because healthsoppe need to notify you on amount of money that has been creadit to your wallet account.You can make a withdrawal request or make a purchase in Healthshoppe.Hope you enjoy to be part of our team.</div>
																				</td>
																			</tr>
																		</table>
																		<!-- // CONTENT TABLE -->

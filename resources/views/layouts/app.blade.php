...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="assets/img/favicons/logo.png">

        <link rel="icon" type="image/png" href="{{ asset('assets/img/favicons/logo.png') }}" sizes="16x16">
        <link rel="icon" type="image/png" href="{{ asset('assets/img/favicons/logo.png') }}" sizes="32x32">
        <link rel="icon" type="image/png" href="{{ asset('assets/img/favicons/logo.png') }}" sizes="96x96">
        <link rel="icon" type="image/png" href="{{ asset('assets/img/favicons/logo.png') }}" sizes="160x160">
        <link rel="icon" type="image/png" href="{{ asset('assets/img/favicons/logo.png') }}" sizes="192x192">

        <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('assets/img/favicons/logo.png') }}">
        <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('assets/img/favicons/logo.png') }}">
        <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('assets/img/favicons/logo.png') }}">
        <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/img/favicons/logo.png') }}">
        <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('assets/img/favicons/logo.png') }}">
        <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('assets/img/favicons/logo.png') }}">
        <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('assets/img/favicons/logo.png') }}">
        <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('assets/img/favicons/logo.png') }}">
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/img/favicons/logo') }}">
        <!-- END Icons -->
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white">
                               <img src="{{ asset('assets/img/logo.png') }}" width="60" height="50"><span class="h5 font-w600 sidebar-mini-hide">HealthShoppe</span>
                            </a>
                        </div>
                        <!-- END Side Header -->`
                        ...
                        <div class="side-content side-content-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a class="{!! classActivePath('product-approval') !!}" href="{{url('/product-approval')}}"><i class="fa fa-shopping-cart"></i><span class="sidebar-mini-hide">Product Approval</span></a>
                                </li>
                                <li>
